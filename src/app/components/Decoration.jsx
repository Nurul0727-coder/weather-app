...
export function Icons({ iconColor = 'black' }) {
  ...
  return (
    <div className="absolute ml-[120px] mt-[850px] h-32 w-[360px] flex justify-around z-40 overflow-visible">
...
export function YellowCircle() {
    return (
      <div className="absolute ml-[70px] mt-[60px]">
        <svg width="150" height="150" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 176 176" fill="none">
          ...
          <defs>
            <radialGradient id="paint0_radial" cx="50%" cy="50%" r="50%" gradientUnits="userSpaceOnUse"gradientTransform="translate(64 64) rotate(90) scale(64)">
  ...
  export function BlueCircle() {
    return (
      <div className="absolute ml-[400px] mt-[830px]">
